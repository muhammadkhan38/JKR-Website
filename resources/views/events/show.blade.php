...
<section class="bg-emerald-950 text-white">
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        @endif
        <p class="text-sm font-semibold uppercase tracking-wide text-amber-300">Islamic Collection</p>
...
<section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        @empty
            <p class="rounded-md border border-dashed border-emerald-200 p-6 text-stone-600">No books attached to this collection yet.</p>
        @endforelse
    </div>
    ...
    @if($audios->isNotEmpty())
        <div class="mt-12">
            <p class="section-kicker">Collection Audio</p>
            <h2 class="section-heading">Related Lectures</h2>
